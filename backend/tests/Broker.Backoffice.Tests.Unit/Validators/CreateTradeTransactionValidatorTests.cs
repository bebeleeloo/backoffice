...
public class CreateTradeTransactionValidatorTests
{
    private readonly CreateTradeTransactionCommandValidator _validator = new();

    private static CreateTradeTransactionCommand ValidCommand() => new(
