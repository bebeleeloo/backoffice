...
public class UpdateExchangeValidatorTests
{
    private readonly UpdateExchangeCommandValidator _validator = new();

    private static UpdateExchangeCommand ValidCommand() => new(
        Id: Guid.NewGuid(),
        Code: "NYSE",
