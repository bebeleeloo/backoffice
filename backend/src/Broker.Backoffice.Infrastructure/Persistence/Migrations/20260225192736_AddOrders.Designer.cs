...
namespace Broker.Backoffice.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260225192736_AddOrders")]
            ...
            modelBuilder.Entity("Broker.Backoffice.Domain.Orders.NonTradeOrder", b =>
                {
                    ...
                    b.HasOne("Broker.Backoffice.Domain.Orders.Order", "Order")
                        ...
                        .HasForeignKey("Broker.Backoffice.Domain.Orders.NonTradeOrder", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Broker.Backoffice.Domain.Orders.TradeOrder", b =>
                {
                    b.HasOne("Broker.Backoffice.Domain.Orders.Order", "Order")
                        .WithOne("TradeOrder")
                        .HasForeignKey("Broker.Backoffice.Domain.Orders.TradeOrder", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
