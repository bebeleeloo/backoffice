...
namespace Broker.Backoffice.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260225195544_ChangeOrderFkToOrderId")]
    partial class ChangeOrderFkToOrderId
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Broker.Backoffice.Domain.Orders.NonTradeOrder", b =>
                {
                    ...
                    b.HasOne("Broker.Backoffice.Domain.Orders.Order", "Order")
                        .WithOne("NonTradeOrder")
                        .HasForeignKey("Broker.Backoffice.Domain.Orders.NonTradeOrder", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Broker.Backoffice.Domain.Orders.TradeOrder", b =>
                {
                    ...
                    b.HasOne("Broker.Backoffice.Domain.Orders.Order", "Order")
                        .WithOne("TradeOrder")
                        .HasForeignKey("Broker.Backoffice.Domain.Orders.TradeOrder", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
