...
import { DetailField, EntityHistoryDialog, PageContainer, useHasPermission } from "@broker/ui-kit";
  ...
  if (!order) {
    return (
      <Box sx={{ p: 3 }}>
        ...
        <Typography sx={{ mt: 1 }}>
          <Link component={RouterLink} to="/trade-orders">Return to Trade Orders list</Link>
        </Typography>
      </Box>
    );
  }
