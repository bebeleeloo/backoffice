...
**Broker Backoffice** -- внутренняя система управления брокерским бэк-офисом. Позволяет администраторам управлять клиентами, пользователями, ролями и правами доступа, просматривать аудит-лог операций.
